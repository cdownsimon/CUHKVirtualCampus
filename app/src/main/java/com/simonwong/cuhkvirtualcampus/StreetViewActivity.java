    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                boolean isFirstStart = getPrefs.getBoolean("StreetviewfirstStart", true);

                //  If the activity has never started before...
                if (isFirstStart) {

                    //  Launch app intro
                    final Intent i = new Intent(StreetViewActivity.this, FrontIntroActivity.class);

                    i.putExtra("LaunchFrom", "Streetview");
                    ...
                    e.putBoolean("StreetviewfirstStart", false);
